<?php $this->layout('template', ['title' => 'iClean - Diensten', 'id' => 'diensten', 'extracss' => '/static/css/pages.css']) ?>

<div class="container" id="diensten">
	<h1>Diensten</h1>
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<img src="/static/img/foto/picolo.jpg" alt="Ramen wassen" class="img-fluid">
